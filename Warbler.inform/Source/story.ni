...
The homespun shift is part of the player. The description is "Your clothing." Understand "shift" as the homespun shift.
...
To say flittiness:
	If the invisible bird is in the middlereeds and the flittiness of invisible bird is true:
...
Instead of going the reeds while the player is in the beach, try going north.
